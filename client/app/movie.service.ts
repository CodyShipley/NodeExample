namespace app.services {
    interface IMovieResourceClass extends IMovie,
        ng.resource.IResource<IMovieResourceClass> { }

    interface IMovieResource extends
        ng.resource.IResourceClass<IMovieResourceClass> {
